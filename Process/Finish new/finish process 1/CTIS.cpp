...
/*
 * A Covid Testing Information System (CTIS) is required
 * that to allow the health ministry to keep track of tests
 * that have been performed by the various test centres.*/
...
void CTIS::showAllCentreOfficers() {
    for (co = CTISCentreOfficers.begin(); co < CTISCentreOfficers.end(); co++)
        cout << *co << endl;
}
