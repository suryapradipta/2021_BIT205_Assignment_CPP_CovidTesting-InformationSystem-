...
private:
    ...
    vector<CovidTest> testerCovidTest; // covid test
...
// ==== test centre
    ...
    CentreOfficer *findCentreOfficer(string centreName);
    TestKit *findTestKitByCentreOfficer(CentreOfficer &centreOfficer, string kitID);


    bool availableTestKit();
    bool kitIDValidation(string kitID);
