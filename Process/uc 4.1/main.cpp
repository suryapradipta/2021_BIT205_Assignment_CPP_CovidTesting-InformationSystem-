...
void recordNewTest() {
    ...
    cout << "Enter username: ";
    cin >> username;
    if(CTISSystem.findPatientByUsername(username)) { // jika tidak ada di vector
        cout << "Enter password: ";
        cin >> password;
        cout << "Enter name: ";
        getline(cin >> ws, name);
    ...
    // jika tidk ada di vector
    // ambil object patient berdasarkan username
    patientTest = &CTISSystem.getPatient()[CTISSystem.getPatient(username)];
    // bikin obeject covid test
    ...
    if(patientTest->getCovidTestCollection().empty()) {
        ...
        cout << "Enter symptoms: ";
        getline(cin >> ws, symptoms);
        patientTest->setPatientType(tempPatient.getPatientType()[iPatientType-1]);
...
// jika ada get di vector
    // kalo mau nampilin patient
    // ambil object patient username
    // tampilkan
    ...
    /*
   apakah ada di vector
   jika true / tambahkan ke vector
   jika tidak ambil get patient di vector
