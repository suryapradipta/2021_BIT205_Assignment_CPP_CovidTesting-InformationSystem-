...
public:
    ...
    vector<CovidTest> getTesterCovidTestCollection() const;
...
// ==== test centre
    ...
    bool findUsernamePatient(string username);
    void showAllPatientName();
    Patient *patientValidation(string username, string password, string name);
    int *getIndexPatient(string username, string password, string name);
